...
export default function Bookings() {
  ...
  if (selectedFilter === 'Checked in') {
    bookings = bookings.filter(booking => booking.bookingStatus === 'checked in');
  } else if (selectedFilter === 'Checked out') {
    bookings = bookings.filter(booking => booking.bookingStatus === 'checked out');
  } else if (selectedFilter === 'Unconfirmed') {
    bookings = bookings.filter(booking => booking.bookingStatus === 'unconfirmed');
  }
